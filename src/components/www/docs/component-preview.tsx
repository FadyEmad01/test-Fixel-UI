...
import { ComponentWrapper } from '@/components/www/docs/component-wrapper';
import {
  Tabs,
  TabsList,
  TabsTrigger,
  TabsContent,
} from '@/components/www/ui/tabs';
import { Loader } from 'lucide-react';
import { Suspense, useEffect, useMemo, useState } from 'react';
import { DynamicCodeBlock } from '@/components/www/docs/dynamic-codeblock';
      ...
      <Tabs defaultValue="preview" className="relative mr-auto w-full">
        ...
        >
          <TabsList className='bg-transparent'>
            <TabsTrigger className='data-[state=active]:bg-accent! data-[state=active]:shadow-none border-none' value="preview">Preview</TabsTrigger>
            <TabsTrigger className='data-[state=active]:bg-accent! data-[state=active]:shadow-none border-none' value="code">Code</TabsTrigger>
          </TabsList>
        </div>
          ...
          >
            <div className="flex flex-col space-y-4">
              <div className="w-full rounded-md [&_pre]:my-0 [&_pre]:h-[400px] h-[450px] [&_pre]:overflow-x-hidden">
                <DynamicCodeBlock
                  code={code}
                  lang="tsx"
                  title={`${name}.tsx`}
